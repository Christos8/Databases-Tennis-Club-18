...
SELECT_LESSON_FROM_ID = "SELECT * FROM LESSON WHERE id = (?)"
SELECT_LESSON_PARTICIPATION = "SELECT * FROM LESSON_PARTICIPATION WHERE playerid = (?) AND lessonid = (?)"
SELECT_LESSON_PARTICIPATION_PLAYERID = "SELECT * FROM LESSON_PARTICIPATION WHERE playerid = (?)"
SELECT_ACTIVE_SUBSCRIPTION = "SELECT * FROM SUBSCRIPTION WHERE playerid = (?) AND status = 'Active'"
...
SELECT_RESERVATIONS_BY_MONTH = "SELECT *FROM reservation WHERE substr(date, 4, 2) = (?) ORDER BY date ASC";
SELECT_RESERVATIONS_BY_DATE = "SELECT *FROM reservation WHERE date = (?)"
SELECT_SUBSCRIPTION_END_DATE = "SELECT enddate FROM subscription WHERE playerID = (?) AND status = 'Active'"
SELECT_RESERVATIONS_BY_PLAYERID = "SELECT * FROM RESERVATION WHERE playerid = (?)"